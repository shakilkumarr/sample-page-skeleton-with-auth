  ...
  <div className="min-h-screen bg-gray-200 flex items-center justify-center text-black">
    ...
    <div className="bg-white shadow-lg rounded px-8 py-12 flex flex-col w-1/3 h-1/2 mx-auto">
      ...
      <div className="flex justify-between">
        {
          [{key: '/google-icon.svg', label: 'GOOGLE'}, {key: '/meta-icon.svg',  label: 'META'}].map(({ key, label }) => (
            <button key={key} className="border border-gray-300 text-gray-500 py-2 px-4 rounded flex items-center w-1/2 mx-auto h-8 mr-4">
